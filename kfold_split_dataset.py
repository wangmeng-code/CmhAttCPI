...
if __name__ == '__main__':
    DATASET = 'user-dataset'   # ['BindingDB', 'DrugBank', 'GPCR', 'Davis','user-dataset']
    SEED=1234
    n_fold=5
    train_rate = 0.875

    save_path = './cross_validation/' + DATASET + '/5fold_data/'
    os.makedirs(save_path, exist_ok=True)

    Data = pd.read_csv('./dataset/' + DATASET + '.txt', sep=' ', header=None)
