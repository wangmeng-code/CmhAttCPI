...
if __name__ == "__main__":
    ...
    test_data = pd.read_csv(root_path  + 'prediction_data.txt',sep=' ',header=None)
    ...
    with open(save_path + 'test_input', 'wb') as f:
        pickle.dump(test_data_pack, f, protocol=0)
    
    pickle_dump(atom_dict, save_path + 'test_atom_dict')
    pickle_dump(bond_dict, save_path + 'test_bond_dict')
    pickle_dump(word_dict, save_path + 'test_word_dict')
