...
if __name__ == "__main__":
    ...
    for fold in range(Kfolds):
        ...
        with open(save_path + str(fold) + 'fold_train_input', 'wb') as f:
            pickle.dump(train_data_pack, f, protocol=0)

        with open(save_path + str(fold) + 'fold_val_input', 'wb') as f:
            pickle.dump(val_data_pack, f, protocol=0)

        with open(save_path + str(fold) + 'fold_test_input', 'wb') as f:
